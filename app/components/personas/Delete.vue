...
const handleDelete = async () => {
  ...
  try {
    ...
    toast.add({
      ...
      description: t('success.description', { name: props.persona.name }),
    })
...
en:
  modal:
    ...
    description: Deleting a persona requires confirmation.
  content:
    title: Delete Persona
    description: You are about to remove the persona {name} from LMiX.
    alert:
      title: Warning
      description: Deleting a persona is permanent and cannot be undone. Are you sure you want to delete it?
  cancel: Cancel
  delete: Delete
  success:
  ...
  error:
    description: Failed to delete the persona. Please try again.
</i18n>
